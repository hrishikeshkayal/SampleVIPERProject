...
/**
 * Created by Hrishikesh on 6/30/2018.
 */
...
public class DownloadTask extends AsyncTask<String, Integer, String> {
    ...
    protected void onPreExecute() {
        ...
        mWakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK,
                getClass().getName());
        mWakeLock.acquire();
        downloadTaskCallBack.onDownloadStarted();
    }
    ...
    protected void onProgressUpdate(Integer... progress) {
        ...
        downloadTaskCallBack.onDownloadProgress(progress[0]);
    }

    @Override
    protected void onPostExecute(String result) {
        mWakeLock.release();
        downloadTaskCallBack.onDownloadFinish();
    }
    ...
    public interface DownloadTaskCallBack{
        ...
        void onDownloadProgress(int amountInPercentage);
    }
